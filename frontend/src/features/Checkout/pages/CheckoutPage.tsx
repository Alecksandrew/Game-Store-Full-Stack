...
export default function CheckoutPage() {
  ...
  const handleCheckoutSubmit = (data: CreditCardFormData) => {
    // I still need to create a global user context.
    execute(data, "Nome do Usuário", "usuario@email.com");
  };
    ...
    <>
      ...
      <div className="bg-bg-primary min-h-screen py-10">
        <div className="w-9/10 max-w-[1200px] mx-auto">
          <h1 className="text-4xl text-text-primary font-orbitron mb-6">Checkout</h1>
