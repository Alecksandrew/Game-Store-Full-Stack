...
using GameStoreAPI.Features.Authentication.Dtos.ConfirmEmail;
using GameStoreAPI.Features.Authentication.Dtos.ForgotPassword;
using GameStoreAPI.Features.Authentication.Dtos.LoginAccount;
using GameStoreAPI.Features.Authentication.Dtos.LogoutAccount;
using GameStoreAPI.Features.Authentication.Dtos.RefreshToken;
...
namespace GameStoreAPI.Features.Authentication
{
    [ApiController]
